...
function CarouselInicio(props) {
  ...
  {
    let response = await fetch(`https://juliamicelipitta.com/api/Cover.php`);
  ...
  //const handleInterval = (interval = false) => interval;
  ...
  return (
    ...
    {/* <ItemComponent activeIndex={index}
    ...
    >
      ...
      {/* <Carousel.Item className="inicio">
        <video
          src={c0.default}
          className="myVideo"
          autoPlay
